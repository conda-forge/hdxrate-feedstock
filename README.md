...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hdxrate-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11076&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hdxrate-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hdxrate` can be installed with:

```
conda install hdxrate
```

It is possible to list all of the versions of `hdxrate` available on your platform with:
